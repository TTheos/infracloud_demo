...
APIHOST = "http://library.demo.local/api/v1/books"
LOGIN = "cisco"
PASSWORD = "Cisco123!"
...
def addBook(book, apiKey):
    ...
    "X-API-KEY": "cisco|mY3xvyPkhPkqLFiMb3UVJpxxbYd5v8CQGY7LaJRk_M0"
    },
...
# apiKey = getAuthToken()
apiKey = "cisco|mY3xvyPkhPkqLFiMb3UVJpxxbYd5v8CQGY7LaJRk_M0"
